...
router.post('/register',async(req,res)=>{
    const { name,email,phone,password,cpassword,secret_key } = req.body
    if( !name || !email || !phone || !password || !cpassword || !secret_key ){
    ...
    try {
        ...
        const user = new User({ name,email,phone,password,cpassword,secret_key});
        await user.save();
...
router.post('/newUser',async(req,res)=>{
    ...
    try {
        ...
        const user = new NewUser({ name,email,phone,password,cpassword,secret_key});
        await user.save();
...
router.post('/updateUser',async(req,res)=>{
    const {id,img,name,email,phone,password,cpassword} = req.body;
...
router.post('/updateUser2',async(req,res)=>{
